...
TEST_F(BtsPortTestSuite, shallSendMessage)
{
    common::BinaryMessage msg;
    EXPECT_CALL(transportMock, sendMessage(_)).WillOnce([&msg](auto param) { msg = std::move(param); return true; });
    objectUnderTest.sendMessage(PHONE_NUMBER_RECIPIENT, "Wiadomość");
    common::IncomingMessage reader(msg);
...
TEST_F(BtsPortTestSuite, shallSendCallRequest)
{
    common::BinaryMessage msg;
    EXPECT_CALL(transportMock, sendMessage(_)).WillOnce([&msg](auto param) { msg = std::move(param); return true; });
    objectUnderTest.sendCallRequest(PHONE_NUMBER_RECIPIENT);
    common::IncomingMessage reader(msg);
...
TEST_F(BtsPortTestSuite, shallSendCallDropped)
{
    common::BinaryMessage msg;
    EXPECT_CALL(transportMock, sendMessage(_)).WillOnce([&msg](auto param) { msg = std::move(param); return true; });
    objectUnderTest.sendCallReject(PHONE_NUMBER_RECIPIENT);
    common::IncomingMessage reader(msg);
...
TEST_F(BtsPortTestSuite, shallSendCallAccepted)
{
    common::BinaryMessage msg;
    EXPECT_CALL(transportMock, sendMessage(_)).WillOnce([&msg](auto param) { msg = std::move(param); return true; });
    objectUnderTest.sendCallAccepted(PHONE_NUMBER_RECIPIENT);
    common::IncomingMessage reader(msg);
